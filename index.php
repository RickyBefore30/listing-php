...
<head>
    ...
    <title>LUXIMA | Directory & Listings </title>
...
<body>
    ...
    <div id="app" class="page_wrapper">
                        ...
                        <nav class="uk-navbar-container uk-navbar-transparent header-navigation uk-dropnav" uk-dropnav="align: center">
                            <ul id="menu-global" class="menu uk-tab uk-subnav uk-flex-center">
                                ...
                                <li class="menu_item">
                                    ...
                                    <div class="uk-dropdown">
                                        <ul class="uk-nav uk-dropdown-nav">
                                            <li><a href="listing-detail">Listing Items</a></li>
                    ...
                    <div class="uk-width-1-4">
                        ...
                        <div class="widget">
                            <div id="" class="uk-dark" data-area="header-widget-one">
                                ...
                                <!-- <form action="https://tiare.qodeinteractive.com/" class="qodef-search-cover-form" method="get">
                                    <div class="qodef-m-inner">
                                        <input type="text" placeholder="Search..." name="s" class="qodef-m-form-field" autocomplete="off" required="">
                                        <a href="javascript:void(0)" class="qodef-opener-icon qodef-m qodef-source--svg-path qodef-m-close">
                                            <span class="qodef-m-icon qodef--open">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="12px" height="12px" viewBox="0 0 12 12" enable-background="new 0 0 12 12" xml:space="preserve">
                                                <polygon fill="#656565" points="11.395,1.515 10.688,0.808 6,5.495 1.312,0.808 0.605,1.515 5.293,6.202 0.605,10.89 1.312,11.597 
                                                    6,6.909 10.688,11.597 11.395,10.89 6.707,6.202 "></polygon>
                                                </svg> 
                                            </span>
                                        </a>
                                    </div>
                            ...
                            <div class="uk-navbar">
                                ...
                                <div class="uk-navbar-dropdown" uk-drop="boundary: !.header-mobile; stretch: x; flip: false; mode: click">
                                        ...
                                        <ul class="uk-nav-default" uk-nav>
                                            <li class="uk-active"><a href="#" class="uk-text-uppercase">HOME</a></li>
                                            ...
                                            <li class="uk-parent">
                                                <a href="#" class="uk-text-uppercase">Listings <span uk-nav-parent-icon></span></a>
                                                    ...
                                                    <ul class="uk-nav-sub">
                                                        <li class="uk-active"><a href="listings">Listing Items</a></li>
                                                        <li><a href="listing-maps">Listing Maps</a></li>
                                                        <li><a href="listing-list">Listing List Compact</a></li>
                                        ...
                                        <div class="elemen_container">
                                            <div  class="elemen_row">
                                                <div class="banner">
                                                    ...
                                                    <!-- <div class="slideshow">
                                                        <div class="slideshow-image" style="background-image: url('assets/images/heroimg/img4.jpg')"></div>
                                                        <div class="slideshow-image" style="background-image: url('assets/images/heroimg/img6.jpg')"></div>
                                                        <div class="slideshow-image" style="background-image: url('assets/images/heroimg/img7.jpg')"></div>
                                                        <div class="slideshow-image" style="background-image: url('assets/images/heroimg/img8.jpg')"></div>
                                                    </div> -->
                                                    ...
                                                    <div class="uk-inline uk-margin uk-section uk-position-cover " uk-scrollspy="cls: uk-animation-slide-bottom; target: .slide-animasi; delay: 300; repeat: true">
                                                        <div class="uk-position-bottom-right uk-overlay">
                                                            <div class="uk-grid-small uk-child-width-auto" uk-grid uk-countdown="date: 2024-05-08T10:33:48+00:00">
                                                                <div>
                                            ...
                                            <!-- <div class="uk-grid-small uk-child-width-1-1 uk-child-width-1-2@s uk-child-width-1-3@m uk-text-center" uk-grid>
                                                ...
                                                <div class="card-shop uk-margin-small-bottom">
                                                    <div class="uk-inline uk-margin-small-bottom uk-transition-toggle" tabindex="0">
                                                        ...
                                                        <img class="uk-transition-scale-up uk-transition-opaque" src="assets/images/shop/shop-13-600x792.jpg" alt="" uk-cover>
        ...
        <!-- Page Outer -->
        <footer class="footer">
            <div class="f-top-area row">
                <div class="uk-container uk-container-xlarge uk-margin-large-left uk-margin-large-right ">
                    <div class="uk-child-width-1-1 uk-child-width-1-2@s uk-child-width-1-4@m uk-text-center uk-grid-divider " uk-grid>
